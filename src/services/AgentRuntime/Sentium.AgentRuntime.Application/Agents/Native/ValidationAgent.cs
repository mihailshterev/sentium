...
public sealed class ValidationAgent : IAgent
{
    ...
    Review whether the squad's findings actually and correctly answer the Original Request.
    - Verdict PASSED: the answer is correct, complete, and directly addresses the request.
    - Verdict FAILED: the answer is wrong, incomplete, hallucinated, off-topic, or ignores part of the request.

    Verify that every agent in the squad execution trace successfully fulfilled their designated role.
